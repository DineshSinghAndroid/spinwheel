    ...
    return Consumer<LudoProvider>(
      builder: (context, value, child) => RippleAnimation(
        ...
        child: CupertinoButton(
          ...
          child: value.diceStarted ? Image.asset("assets/ludoOffline/images/dice/draw.gif", fit: BoxFit.contain) : Image.asset("assets/ludoOffline/images/dice/${value.diceResult}.png", fit: BoxFit.contain),
        ),
      ),
    );
  }
