...
import 'package:spinwheel/GamesViews/LudoOffline/boardUI/widgets/pawn_widget.dart';
...
class BoardWidget extends StatelessWidget {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        image: const DecorationImage(
          image: AssetImage("assets/ludoOffline/images/board.png"),
          fit: BoxFit.cover,
  ...
  List<Widget> winners(BuildContext context, List<LudoPlayerType> winners) => List.generate(
        winners.length,
        (index) {
          Widget crownImage = Image.asset("assets/ludoOffline/games/ludo/crown/1st.png");
          ...
          if (index == 0) {
            crownImage = Image.asset("assets/ludoOffline/images/crown/1st.png", fit: BoxFit.cover);
          } else if (index == 1) {
            crownImage = Image.asset("assets/ludoOffline/images/crown/2nd.png", fit: BoxFit.cover);
          } else if (index == 2) {
            crownImage = Image.asset("assets/ludoOffline/images/crown/3rd.png", fit: BoxFit.cover);
          } else {
            return Container();
          }
